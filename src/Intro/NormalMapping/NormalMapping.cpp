...
bool init()
{
	...
	string vsh_src((istreambuf_iterator<char>(fstream("NormalVertex.glsl"))), istreambuf_iterator<char>());
	string fsh_src((std::istreambuf_iterator<char>(fstream("NormalFragment.glsl"))), istreambuf_iterator<char>());
